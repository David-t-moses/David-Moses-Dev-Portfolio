...
export default function Home() {
  return (
    <div className="relative top-0 flex flex-col overflow-x-hidden">
      ...
      <Services />
      <TransitionWrapper>
        <div className="w-full max-w-7xl px-4 xl:px-14 py-[100px] flex flex-col justify-center items-center max-md:text-center bg-slate-950 mx-auto max-sm:hidden">
          <div className="relative  flex flex-col mx-auto bg justify-center w-full max-h-36 overflow-hidden rounded-lg text-white">
            ...
            <div className="flex justify-between absolute top-0 left-0 z-20 w-full h-full gap-6 p-3 md:p-8 items-center">
              <div className="">
                <h1 className="font-semibold md:text-2xl texzPt-[12px]">
