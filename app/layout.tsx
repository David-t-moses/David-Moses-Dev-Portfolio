...
export const metadata: Metadata = {
  ...
  description:
    "Welcome to my Portfolio! I'm David, I specialize in creating innovative web and software solutions using modern technologies like JavaScript, Python, and React.js. Explore my projects, skills, and experience in front-end, back-end, and full-stack development.",
  keywords:
